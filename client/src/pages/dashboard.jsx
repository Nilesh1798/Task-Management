  ...
  const TableHeader = () => (
    <thead className="border-b border-gray-300 ">
      <tr className="text-black text-left">
        ...
        <th className="py-2 hidden md:block">Submitted</th>
      </tr>
    </thead>
  );
...
const Dashboard = () => {
  ...
  const stats = [
    ...
    },
    {
      ...
      total: dashboardData?.tasks?.["completed"] || 0,
    ...
    },
    {
      ...
      total: dashboardData?.tasks?.["in progress"] || 0,
    ...
    },
    {
      _id: "4",
      label: "TODOS",
      total: dashboardData?.tasks?.["todo"] || 0,
      icon: <FaArrowsToDot />,
      bg: "bg-[#be185d]" || 0,
    },
  ];
